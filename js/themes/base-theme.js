...
export default {
  ...
  // Button
  btnFontFamily: (Platform.OS === 'ios') ? 'worksans-medium' : 'Roboto_medium',
  ...
  // Font
  fontFamily: (Platform.OS === 'ios') ? 'worksans-medium' : 'Roboto',
  fontSizeBase: 15,
  ...
  toolbarDefaultBg: (Platform.OS === 'ios') ? '#FFFFFF' : '#4179F7',
