...
const image = require('../../../images/slide4.png');
...
class Slide1 extends Component{
    ...
    renderContent2(){
        ...
        <View style={styles.bg1}>
             <Text style={_.assign({}, baseStyle.regulartext,{fontSize: 20, fontWeight:'600'} )}>Message</Text>
        </View>
        );
    }
    ...
    renderContent3(){
        ...
        <View style={styles.bg}>
            <Text style={_.assign({}, baseStyle.regulartext,{lineHeight: 20} )}>Message attendees through the PartyOn chat. Join the party if you want to be notified of messages.</Text>
            <Text style={_.assign({}, baseStyle.regulartext,{lineHeight: 20, marginTop:20} )}>Message rooms disappears once the PartyOn expires.</Text>
        </View>
        );
    }
