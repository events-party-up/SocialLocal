...
class Slide1 extends Component{
    ...
    renderContent2(){
        ...
        <View style={styles.bg1}>
             <Text style={_.assign({}, baseStyle.regulartext,{fontSize: 20, fontWeight:'600'} )}>PartyOn</Text>
        </View>
        );
    }
    ...
    renderContent3(){
        ...
        <View style={styles.bg}>
            <Text style={_.assign({}, baseStyle.regulartext,{lineHeight: 20} )}>Each event, or PartyOn, is for a set duration. You can initiate your PartyOn with the + button at the bottom of the screen</Text>
        </View>
        );
    }
