...
class AnimatedPriceMarker extends React.Component {
  render() {
    ...
    return (
      <Animated.View style={_.assign({},styles.container, style)}>
        <Animated.View
          style={_.assign({},
            styles.bubble,
            {
        ...
        <Animated.View
          style={_.assign({},styles.arrowBorder, { borderTopColor: border })}
        />
        <Animated.View
          style={_.assign({},styles.arrow, { borderTopColor: background })}
        />
      </Animated.View>
    );
  }
