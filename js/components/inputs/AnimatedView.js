...
class AnimatedViews extends React.Component {
  ...
  render() {
    ...
    return (
      <View style={_.assign({},styles.container, this.props.style)}>
        <PanController
        ...
        >
              <MapView.Animated key="mapview" style={styles.map}
...
const styles = {
  ...
  itemContainer: {
    ...
    position: 'absolute',
    top: deviceHeight - ITEM_PREVIEW_HEIGHT - 64,
    left: 0
    //paddingTop: deviceHeight - ITEM_PREVIEW_HEIGHT - 64,
