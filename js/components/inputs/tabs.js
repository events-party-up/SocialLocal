...
class Tabs extends Component {
    ...
    render(){
        ...
        return (
            <View style={Object.assign({},styles.tabbarView, this.props.style, this.state.keyboardUp && styles.hidden)}>
                {React.Children.map(this.props.children.filter(c=>c),(el)=>
                    <TouchableOpacity key={el.props.name+"touch"}
                       testID={el.props.testID}
                       style={Object.assign({},styles.iconView, this.props.iconStyle, (el.props.name || el.key) == selected ? styles.selectedIconStyle || el.props.selectedIconStyle || {} : {} )}
