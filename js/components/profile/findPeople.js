...
/* Open source modules */
import {View, Image, TouchableOpacity,TouchableHighlight ,InteractionManager,TextInput ,ListView,FlatList} from 'react-native'
...
class Profile extends Component{
  ...
  userViewProfile(userRowData, loggedInUserId){
	...
	renderListView(){
     //console.log("data source ", this.state.data)
    // console.log('====',[{key: 'a'}, {key: 'b'}].constructor === Array);
        return ( 
